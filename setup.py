...
from tomate import get_version
...
if __name__=='__main__':
    setup(
        ...
        url = 'https://github.com/hdknr/tomate',
        description = 'tomate is a Django based management interface for databases.',
        long_description = read('README.rst'),
        download_url = 'https://github.com/hdknr/tomate',
        platforms=['any'],
        classifiers = [
