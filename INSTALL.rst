========================================================================
**tomate** Installation Instructions
========================================================================

This section contains information about 
how to download and install **tomate** in your system. 
...
inside the ** tomate ** distribution package. 
...
URL is https://github.com/hdknr/tomate


Install
=======

To install **tomate** from soruce code, use the provided installation script::
...
the `source code repository`_ using ``pip``::
    ...
    pip install -e git+https://github.com/hdknr/tomate

The above command will install the latest development release of **tomate**.
